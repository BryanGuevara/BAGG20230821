...
public class ComunDB { 
    ...
    static String connectionUrl = "jdbc:sqlserver://localhost:1433;database=UbicaMovil;user=root;password=;loginTimeout=30;encrypt=false;trustServerCertificate=false";    
